...
int main(int argc, char const *argv[]) {
    ...
    static const char *menu1options[] = {"Draw a straight line", "Draw a circumference",
                                         "Draw tangents to a circumference passing through a point", "Draw a parabola",
                                         "Draw an hyperbole", "Exit"};
    ...
    switch (place) {
        case 0: {
            ...
            Ui_readInput(
                    "Please enter the coefficient m (numbers with a maximum of 6 digits after the comma are accepted)",
                    "%f", &SINGLE.line.m);
            Ui_readInput(
                    "Please enter the coefficient q (numbers with a maximum of 6 digits after the comma are accepted)",
                    "%f", &SINGLE.line.q);
        ...
        case 1: {
            ...
            Ui_clear();
            Ui_printWithNewLine(
                    "The circumference equation must be in the following form: x^2 + y^2 + ax + by + c = 0\n");
            Ui_readInput(
                    "Please enter the coefficient a (numbers with a maximum of 6 digits after the comma are accepted)",
                    "%f", &SINGLE.circumference.a);
            Ui_readInput(
                    "Please enter the coefficient b (numbers with a maximum of 6 digits after the comma are accepted)",
                    "%f", &SINGLE.circumference.b);
            Ui_readInput(
                    "Please enter the coefficient c (numbers with a maximum of 6 digits after the comma are accepted)",
                    "%f", &SINGLE.circumference.c);
            Ui_printWithNewLine("\nThe rendering has been started in a new window...");
        ...
        case 2:
            ...
            Ui_readInput(
                    "Please enter the x of the point (numbers with a maximum of 6 digits after the comma are accepted)",
                    "%f", &SINGLE.position.x);
            Ui_readInput(
                    "Please enter the y of the point (numbers with a maximum of 6 digits after the comma are accepted)",
                    "%f", &SINGLE.position.y);
            Ui_readInput(
                    "Please enter the coefficient a (numbers with a maximum of 6 digits after the comma are accepted)",
                    "%f", &SINGLE.circumference.a);
        ...
        case 3: {
            ...
            int type = Ui_handleMenu("Please select the type of the parabola", "Select an option", parabolaTypes, 2,
                                     true);
        ...
        case 4: {
            ...
            static const char *parabolaTypes[] = {"Equation: (x^2 / a^2) - (y^2 / b^2) = 1",
                                                  "Equation: (x^2 / a^2) - (y^2 / b^2) = -1", "Equation: xy = k",
                                                  "Homographic Function: y = (ax + b) / (cx + d)"};
            int type = Ui_handleMenu("Please select the type of the hyperbole", "Select an option", parabolaTypes, 4,
                                     true);
            switch (type) {
                case 0:
                    SINGLE.hyperbole.type = Analytic_HyperboleY;
                    Ui_printWithNewLine(
                            "The hyperbole equation must be in the following form: (x^2 / a^2) - (y^2 / b^2) = 1\n");
                    Ui_readInput(
                            "Please enter the coefficient a^2 (numbers with a maximum of 6 digits after the comma are accepted)",
                            "%f", &SINGLE.hyperbole.a);
                    Ui_readInput(
                            "Please enter the coefficient b^2 (numbers with a maximum of 6 digits after the comma are accepted)",
                            "%f", &SINGLE.hyperbole.b);
                    Ui_printWithNewLine("\nThe rendering has been started in a new window...");
                    break;
                case 1:
                ...
                case 2:
                    ...
                    Ui_readInput(
                            "Please enter the coefficient k (numbers with a maximum of 6 digits after the comma are accepted)",
                            "%f", &SINGLE.hyperbole.k);
                    Ui_printWithNewLine("\nThe rendering has been started in a new window...");
                    break;
                case 3:
                    ...
                    Ui_readInput(
                            "Please enter the coefficient c (numbers with a maximum of 6 digits after the comma are accepted)",
                            "%f", &SINGLE.hyperbole.c);
                    Ui_readInput(
                            "Please enter the coefficient d (numbers with a maximum of 6 digits after the comma are accepted)",
                            "%f", &SINGLE.hyperbole.d);
                    Ui_printWithNewLine("\nThe rendering has been started in a new window...");
                    break;
            }
            break;
    ...
    window = SDL_CreateWindow("Analytic Window", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, SDL_WINDOW_SIZE,
                              SDL_WINDOW_SIZE, SDL_WINDOW_OPENGL);
